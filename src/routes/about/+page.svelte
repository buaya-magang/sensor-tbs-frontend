...
<div class="container mx-auto grid grid-cols-1 ... px-4 py-12">
	<div class="grid grid-cols-1 items-center gap-y-10 lg:grid-cols-2 lg:gap-x-12">
		...
		<div class="order-2 flex flex-col justify-center space-y-6 text-center lg:order-1 lg:text-left">
			...
			<p class="text-gray-600">
               Aplikasi ini bertujuan untuk meningkatkan efisiensi dan akurasi dalam klasifikasi TBS, yang pada gilirannya akan membantu pengelolaan dan pengambilan keputusan yang lebih baik dalam pertanian kelapa sawit. </p>
              <p class="text-gray-600">
				Pengguna dapat mengunggah gambar TBS. Prediksi dilakukan menggunakan model pembelajaran mesin yang telah dilatih berdasarkan data gambar yang diambil langsung dari lapangan.</p>
